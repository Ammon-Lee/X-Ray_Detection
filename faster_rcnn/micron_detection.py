...
def run_the_app():
    ...
    predict_boxes, predict_classes, predict_scores = faster_RCNN(image=image,
    ...
    draw_image_with_boxes(image,
                          ...
                          "**Faster RCNN Model** (confidence `%3.1f`)" % confidence_threshold)
...
def faster_RCNN(image, weights_path):
    ...
    model = load_network(weights_path=weights_path, device=device)
...
weights_path = './save_weights/resNetFpn-model-21.pth'
path = './train_data/val'
